...
def per_pixel_shadow_time_estimate2(I) :
    ...
    shadow_time[I_max - I_min < 5] = 0
    shadow_time_plot[I_max - I_min < 5] = 0
...
extrinsics = np.load('custom-data-dump/fruits/seq-1/extrinsic_calib.npz')
...
rectangle_bounds_col = [620,1050] #790]#815]
rectangle_bounds_row = [475,725]#630]
P_array = []
p_color_array = []
